...
public class JDKArrayList<E> extends AbstractList<E>implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
	...
	private class SubList extends AbstractList<E>implements RandomAccess {
		...
		public Spliterator<E> spliterator() {
			checkForComodification();
			return new ArrayListSpliterator<E>(JDKArrayList.this, offset, offset + this.size, this.modCount);
		}
	}
	...
	static final class ArrayListSpliterator<E> implements Spliterator<E> {
		...
		ArrayListSpliterator(JDKArrayList<E> list, int origin, int fence, int expectedModCount) {
